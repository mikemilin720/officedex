...
export interface MainState {
  ...
  embedEditingElementId: string
  embedEditingShowCaret: boolean
  pptxPerformanceMode: boolean
}
...
export const useMainStore = defineStore('main', {
  state: (): MainState => ({
    ...
    embedMode: false,
    embedEditable: false,
    embedEditingElementId: '',
    embedEditingShowCaret: false,
    pptxPerformanceMode: false,
  }),
  ...
  actions: {
    ...
    setEmbedMode(val: boolean) {
      this.embedMode = val
    },

    setEmbedEditableMode(val: boolean) {
      this.embedEditable = val
    },

    setEmbedEditingState(elementId: string, showCaret = false) {
      this.embedEditingElementId = elementId
      this.embedEditingShowCaret = showCaret
    },

    setPptxPerformanceMode(val: boolean) {
      this.pptxPerformanceMode = val
    },
  },
})
